...
for (var i=0;i<paesi.length;i++) {
    ...
    titolo.innerHTML = "<q>"+c+"</q>В нашей базе данного человека нет, но это не значит что ему стоит доверять, поскольку данный человек ещё не слит в базах, а если слит то просим сообщить нам об этом.";
